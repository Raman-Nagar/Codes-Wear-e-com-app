...
const Post = ({ addToCart, product, variants, buyNow , error}) => {
  ...
  const [color, setColor] = useState(!error && product.color);
  const [size, setSize] = useState(!error && product.size);
  ...
  const checkServiceAbility = async () => {
    let pins = await fetch(`${process.env.NEXT_PUBLIC_ADMIN_HOST}/api/pincodes`);
        ...
        <div className="container px-5 py-12 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <h1 className="text-gray-900 border-b-2 text-3xl title-font font-medium mb-1">
              ...
              <div className="flex">
                {(product.availableQty < 1) && <span className="title-font font-medium text-2xl text-gray-900">
                  Out of Stock!
                </span>}
                ...
                <button
                  ...
                  disabled={product.availableQty < 1} className="disabled:bg-pink-300 flex items-center ml-5 text-white bg-pink-500 border-0 py-1 px-3 focus:outline-none hover:bg-pink-600 rounded"
                >
                  BuyNow
                </button>
                <button
              ...
              <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start my-3">
                ...
                <button
                  ...
                  className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Check
                </button>
              </div>
